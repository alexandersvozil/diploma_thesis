...
\newcommand{\thesistitle}{The Complexity of SPARQL Query Evaluation and Static
Analysis with focus on the SERVICE and GRAPH Operators} % The title of the thesis. The English version should be used, if it exists.
...
\setadvisor{Professor Dr.}{Reinhard Pichler}{}{male}

% For bachelor and master theses:
%\setfirstassistant{Professor Dr.}{Reinhard Pichler}{}{male}
\setfirstassistant{Dr.}{Sebastian Skritek}{}{male}
...
\setdate{01}{01}{2001}
\settitle{\thesistitle}{The Complexity of SPARQL Query Evaluation and Static
Analysis with focus on the SERVICE and GRAPH Operators} % Sets English and German version of the title (both can be English or German).
...
\chapter{Containment, Equivalence and Subsumption of Well-Designed SPARQL}
\input{pods2014containment.tex}

\chapter{Beyond Well-Designed SPARQL}
\input{beyondwelldesigned.tex}

\chapter{On evaluating the SERVICE operator with variables}
\input{builaranda.tex}



%%%The big new proof %%%%
\chapter{Complexity of EVAL extended to the GRAPH and SERVICE operator}
